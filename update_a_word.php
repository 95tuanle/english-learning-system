...
<div class="container-fluid">
  <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="post">
    <div class="form-group">
      <input placeholder="Word" class="form-control" type="text" name="word"
             value="<?php echo isset($_POST['word']) ? $_POST['word'] : '' ?>">
      <span class="error">* <?php echo $word_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Vietnamese meaning" class="form-control" type="text" name="vietnamese_meaning"
             value="<?php echo isset($_POST['vietnamese_meaning']) ? $_POST['vietnamese_meaning'] : '' ?>">
      <span class="error">* <?php echo $vietnamese_meaning_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Similar words" class="form-control" type="text" name="similar_words"
             value="<?php echo isset($_POST['similar_words']) ? $_POST['similar_words'] : '' ?>">
      <span class="error">* <?php echo $similar_words_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Example 1" class="form-control" type="text" name="example_one"
             value="<?php echo isset($_POST['example_one']) ? $_POST['example_one'] : '' ?>">
      <span class="error">* <?php echo $example_one_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Example 2" class="form-control" type="text" name="example_two"
             value="<?php echo isset($_POST['example_two']) ? $_POST['example_two'] : '' ?>">
