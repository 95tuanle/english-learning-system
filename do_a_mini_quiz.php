...
<div class="container">
  ...
  <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="post">
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="answer" value="<?php echo $answers[0] ?>" <?php if ($_POST['answer'] == $answers[0]) {
          echo "checked";
      } ?> id="<?php echo $answers[0] ?>" class="custom-control-input">
      <label class="custom-control-label" for="<?php echo $answers[0] ?>"><?php echo $answers[0] ?></label>
    </div>
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="answer" value="<?php echo $answers[1] ?>" <?php if ($_POST['answer'] == $answers[1]) {
          echo "checked";
      } ?> id="<?php echo $answers[1] ?>" class="custom-control-input">
      <label class="custom-control-label" for="<?php echo $answers[1] ?>"><?php echo $answers[1] ?></label>
    </div>
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="answer" value="<?php echo $answers[2] ?>" <?php if ($_POST['answer'] == $answers[2]) {
          echo "checked";
      } ?> id="<?php echo $answers[2] ?>" class="custom-control-input">
      <label class="custom-control-label" for="<?php echo $answers[2] ?>"><?php echo $answers[2] ?></label>
    </div>
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="answer" value="<?php echo $answers[3] ?>" <?php if ($_POST['answer'] == $answers[3]) {
          echo "checked";
      } ?> id="<?php echo $answers[3] ?>" class="custom-control-input">
