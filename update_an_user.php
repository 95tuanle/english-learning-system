...
<div class="container-fluid">
  <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="post">
    ...
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="is_admin" value="admin" <?php if ($_POST['is_admin'] == "admin") {
          echo "checked";
      } ?> id="admin" class="custom-control-input">
      <label class="custom-control-label" for="admin">Admin</label>
    </div>
    <div class="custom-control custom-radio custom-control-inline">
      <input type="radio" name="is_admin" value="learner" <?php if ($_POST['is_admin'] == "learner") {
          echo "checked";
      } ?> id="learner" class="custom-control-input">
    ...
    <div class="form-group">
      <input placeholder="Confirm password" class="form-control" type="password" name="confirm_password"
