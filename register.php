...
<div class="container-fluid">
  <form action=" <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="post">
    <div class="form-group">
      <input placeholder="Username" class="form-control" type="text" name="username_register"
             value="<?php echo isset($_POST['username_register']) ? $_POST['username_register'] : '' ?>">
      <span class="error">* <?php echo $username_register_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Email" class="form-control" type="email" name="email_register"
             value="<?php echo isset($_POST['email_register']) ? $_POST['email_register'] : '' ?>">
      <span class="error">* <?php echo $email_register_Err; ?></span>
    </div>

    <div class="form-group">
      <input placeholder="Password" class="form-control" type="password" name="password_register"
             value="<?php echo isset($_POST['password_register']) ? $_POST['password_register'] : '' ?>">
      <span class="error">* <?php echo $password_Err; ?></span>
    </div>
    <div class="form-group">
      <input placeholder="Confirm Password" class="form-control" type="password" name="confirm_password_register"
             value="<?php echo isset($_POST['confirm_password_register']) ? $_POST['confirm_password_register'] : '' ?>">
